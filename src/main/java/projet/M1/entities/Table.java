...
public class Table {
    ...
    // Zone neutre
    public static final float NEUTRAL_Z = HALF_L / 3f;
    ...
    // Zone neutre jaune entre -NEUTRAL_Z et +NEUTRAL_Z
    private void buildNeutralZone() {
        ...
        // Couleur jaune, espace neutre
        mat.setColor("Color", new ColorRGBA(1f, 0.85f, 0f, 0.35f));
    ...
    // Bandes latérales gauche et droite
