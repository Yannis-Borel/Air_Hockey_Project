...
import projet.M1.CountdownState;
...
public class MenuState extends AbstractAppState {
    ...
    private void buildMenu() {
        ...
        addMainButton("Continuer", cx, topY, btnW, btnH, new ColorRGBA(0.1f,  0.5f,  0.1f,  0.95f), this::resume);
        addMainButton("Menu principal", cx, topY - gap, btnW, btnH, new ColorRGBA(0.6f, 0.08f, 0.08f, 0.95f), this::returnToMainMenu);
